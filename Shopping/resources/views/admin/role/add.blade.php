                ...
                <form action="{{route('admin.roles.store')}}" method="post">
                    ...
                    <div class="col-12">
                        <div class="row form-group">
                            ...
                            <textarea name="display_name" class="form-control " id="intro" cols="30" rows="5">{{old('display_name')}}</textarea>
                            <span class="text-danger">{{$errors->first('display_name')}}</span>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="row form-group checka">
                            <div class="col-12">
                                <label>
                                                ...
                                                <h6 class="card-title">
                                                    <label>
                                                        <input type="checkbox" name="permission_id[]"
                                                               class="checkbox_childrent"  value="{{$permissionChidrentItem->id}}">
